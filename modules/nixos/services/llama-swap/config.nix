...
in
{
  ...
  matrix = {
    vars = {
      ...
      ov1 = "ovis-ocr2-cuda1";
      q36a1 = "qwen3.6-35b-cuda1";
    };

    sets = {
      concurrent = "(go | g4 | mg | mg200 | q36a | q36avl | q36b | q36ik | q38 | n38vl | n38rkvl | n38l | n38rk | v180 | v145 | v75 | v50 | ov0 | zi | qie | qi | cr) & (q4 | q9 | ov1 | q36a1)";
    };
  };
